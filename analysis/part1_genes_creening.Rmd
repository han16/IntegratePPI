...
sum(asd_185_genes %in% tada_2022[tada_2022$qvalue<=0.05,]$Gene)
...
```{r, message=F, warning=F}
setdiff(asd_185_genes,tada_2022$Gene) # among 185 ASD genes, there are 13 genes missed in brainspan 
```