...
length(intersect(asd_185_genes, genes_pfc35))
length(setdiff(intersect(asd_185_genes, tada_2022$Gene),genes_pfc35 ))  # 8 genes are missed 
missed_genes=setdiff(intersect(asd_185_genes, tada_2022$Gene),genes_pfc35 )
tada_2022 %>% filter(Gene %in% missed_genes)

length(intersect(asd_185_genes, genes_pfc35_string))
length(setdiff(intersect(asd_185_genes, tada_2022$Gene),genes_pfc35_string))  # number of genes are missed 

length(intersect(genes_pfc35, genes_pfc35_string_combine_adj))
length(setdiff(intersect(asd_185_genes, tada_2022$Gene),genes_pfc35_string_combine_adj))  # number of genes are missed 
